...
## [02/03/2024](https://cssbattle.dev/play/vH2qVEvja02TZ7iSu6Sq)
...
```html
<p><h1><style>*{background:#3A2A5D}p{width:120;height:60;border-radius:0 0 25vw 25vw;color:BBB2DB;border:solid 32q;margin:120 102;box-shadow:0-32q#3A2A5D,0-60px}h1{width:50;height:30;margin:-210 90
```

## [05/03/2024](https://cssbattle.dev/play/p1cEpHID7syoP2rt3Qrk)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_qP6sBz9@2x.png?alt=media">
...
```html
<body bgcolor=611B1A><p><p a><style>p{width:260;height:300;border:solid 5ch#F16B4A;border-radius:0 75vw 0 0;margin:-8-48}[a]{margin:-380 92;scale:-1 1
```

## [06/03/2024](https://cssbattle.dev/play/M6tKYFqVaSqkWkh0B6Zt)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_OCsLA1q@2x.png?alt=media">
...
<style>
  ...
  div {
    ...
    background: #d9d9d9;
    margin: 50 92;
    box-shadow: 80px 0 #d9d9d9, 80px 160px #d9d9d9, 160px 40px #d9d9d9, 0 120px
        #d9d9d9, 160px 160px #d9d9d9;
  }
  [a] {
    width: 200px;
    margin: -10 92;
...
## [08/03/2024](https://cssbattle.dev/play/d2do5giUJ97UakikvOW6)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_PhjRF3i@2x.png?alt=media">
...
```html
<body bgcolor=D5954D><p><p a><p b><style>p{width:160;height:230;border-radius:40vw;border:solid 20px#FFF;margin:120 auto -350}[a]{width:80;border-radius:5em}[b]{width:0;box-shadow:0-392q 0 0#FFF
```

## [09/03/2024](https://cssbattle.dev/play/TLYdjxiOBI0FqI6EpXtW)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_IV5XxMP@2x.png?alt=media">
...
## [12/03/2024](https://cssbattle.dev/play/ejj8M1KWrbENgxA6BYtm)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_vnmxy4k@2x.png?alt=media">
...
<style>
  ...
  div {
    ...
    background: #49c85b;
    margin: 50 102;
    box-shadow: 40px 0 #49c85b, 20px 20px #0a9949, 0 170px #49c85b, 40px 170px
        #49c85b, 20px 150px #0a9949;
  }
  h1 {
    width: 40px;
    height: 150px;
...
```html
<body bgcolor=085328 text=49C85B><p a><p><style>p{width:40;height:200;background:#49C85B;border-radius:20q;margin:-80 172}[a]{width:140;height:30;margin:50 102;box-shadow:5ch 0,21q 21q#0A9949,0 180q,5ch 180q,21q 50vh#0A9949
```

## [13/03/2024](https://cssbattle.dev/play/PvqODmBuQ4SH5lWHLs4M)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_492MNmV@2x.png?alt=media">
...
<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_lRXeTMY@2x.png?alt=media">
...
<style>
  ...
  div {
    ...
    background: #b04183;
    margin: 110 62;
    box-shadow: 100px 0 0 20px #b04183, 170px 0 #b04183;
  }
  h1 {
    width: 10px;
    height: 100px;
    ...
    margin: -200 62;
    border-radius: 10px;
    box-shadow: 65px -25px 0 5px #f7bed9, 65px 25px 0 5px #f7bed9,
      185px -25px 0 5px #f7bed9, 185px 25px 0 5px #f7bed9, 250px 0 #f7bed9;
  }
</style>
```
...
```html
<p><p a><style>p{width:80;height:80;background:currentcolor;color:B04183;margin:110 62-200;box-shadow:25vw 0 0 21q,180q 0,0 0 0 3in#5F133F}[a]{width:10;height:100;color:F7BED9;border-radius:8q;box-shadow:65px -25px 0 5px,65px 25px 0 5px,185px -25px 0 5px,185px 25px 0 5px,250px 0
```

## [24/03/2024](https://cssbattle.dev/play/eYl0NTAF2HmAuNXhphx9)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_AZTAQS4@2x.png?alt=media">
...
<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_NyQm6aW@2x.png?alt=media">
...
<style>
  * {
  ...
  div {
    width: 185px;
    height: 135px;
    box-shadow: 215px 0 #504371, 0 165px #504371, 215px 165px #504371, 0 0 0
        3in#A6A0BE;
  }
  h1 {
    width: 90px;
...
```html
<p><h1><style>*{background:#504371;color:504371;margin:0}p{width:185;height:135;box-shadow:228q 0,0 175q,228q 175q,0 0 0 3in#A6A0BE}h1{width:90;height:90;border:solid 32q#A6A0BE;margin:-60 125;rotate:45deg
```

## [30/03/2024](https://cssbattle.dev/play/ICevkLVnblrBFV2NQeGg)

<img width="400px" height="300px" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/cssbattleapp.appspot.com/o/user%2Fummd3POvEDfFyeFvVdOMG3OOrwE2%2Ftargets%2Ftarget_jEIZ5Hd@2x.png?alt=media">
...
<style>
  ...
  div {
    ...
    background: #81008f;
    margin: 90 67 100;
    box-shadow: 0 40px #81008f, 0 80px #81008f, 170px 20px #81008f, 170px 60px
        #81008f, 170px 100px #81008f;
  }
  [a] {
    height: 120px;
    box-shadow: 80px -120px #81008f, 90px -120px #81008f, 170px -240px #81008f;
  }
</style>
```
